...
//jaisai precise value agar .toPrecision(3) mai agar 3 diye hai aur input 12.889 toh output ayaiga 12.8 like only 3 numbers 
// as the input given in the precision was 3 if i had give (4) and input was 1256.9587, then output would have been 1257 to the nearest value and only 4 digits

const hundreds = 1000000
// console.log(hundreds.toLocaleString('en-IN')); 10,00,000

// waisai default toh american currency hota  hai but agar indian curr mai change karna hai toh 'en-IN' daina parta hai then output will 
// be 10,00,000 this will be the output 
...
console.log(Math.floor(Math.random()*100) +1);// jaisai *10 ka mtlb hai single digit value ayaigie and *100 ka mtlb hai 2
//  digit mai value ayaigie like 65 and 89 aisai
